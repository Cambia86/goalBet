...
(function () {
    ...
    angular
        .module('myApp')
        .controller('previsionCtrl', previsionCtrl);
    previsionCtrl.$inject = ['$state', '$stateParams', '$scope', 'dataFactory'];

    function previsionCtrl($state, $stateParams, $scope, dataFactory) {
